                    ...
                    <div class="celebrate_part mt-5">
                        <div class="row">
                            <div class="col-md-8 paragraph">
                                <h2 class="mb-5 fw-light"><?php echo $value['celebrating_title'] ?></h2>
                                <p> <?php echo $value['celebrating_paragraph'] ?>
                                <p>
        ...
        <section id="Our_Product_Line" class=" background-res py-5" style="background-image:url(<?php echo base_url('frontend_design/assets/images/Opacity-Image-02-1.jpg'); ?>)">
            <div class="container">
                <div class="row mt-3">
                    ...
                    ?>
                        <div class="col-md-4">
                            <h2 class=" text-center mb-3 text-white"><strong><?php echo $value['product_title'] ?></strong> </h2>
                        </div>
                    <?php  } ?>
                    ...
                    ?>
                        <div class="col-md-4">
                            ...
                            <div class="product_text">
                                <h2 class="text-center text-white mt-3"><strong><?php echo $value['product_img_title'] ?></strong></h2>
                            </div>
                        </div>
                    <?php  } ?>
        ...
        <section id="Current_offer" class=" background-res py-5" style="background-image: url(<?php echo base_url('frontend_design/assets/images/Opacity-Image-01-1.jpg'); ?>)">
            <div class="container">
                ...
                ?>
                    <h2 class="fw-bold text-center mt-3 text-white"><?php echo $value['current_title'] ?></h2>
                <?php  } ?>
        ...
        <section id="our_partner" class=" background-res background-ats text-center py-5" style="background-image: url(<?php echo base_url('frontend_design/assets/images/Background-Image-1.png'); ?>)">
            <div class="container">
                <div class="row mt-5">
                    ...
                    ?>
                        <div class="col-md-4 ">
                            <h2 class="fw-bold text-center mb-5"><?php echo $value['partner_title'] ?></h2>
                        </div>
                    <?php  } ?>
